...
const ProjectPage = (props) => {
    ...
    const projectDetails = [
        ...
        },
        {
            ...
            description: [
                ...
                <p key='4'>Some strategies that worked were: using two offense agents and mostly ignoring defense, splitting the food into top and bottom halves so my agents do not pursue the same food, distracting enemy defense agents with one of my offense agents while the other ate all the food, using the allotted fifteen seconds of pregame processing time to detect all of the dead ends so that the agents know when they are trapped and can react accordingly, and much more.</p>,
                <p key='5'>After spending a significant amount of time and energy (and having a great time along the way) I’m proud that my agents won the competition with an overall win rate of ~89%.</p>
            ],
    ...
    function findContent(projectName) {
